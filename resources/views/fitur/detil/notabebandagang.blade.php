                        ...
                        <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="">
                                                            <input type="text" name="namabeban" class="form-control"
                                                                disabled="disabled"
                                                                value="{{ $bebandagang[$loc]['namabeban'] }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-8">
                                    ...
                                    <button class="btn btn-primary center m-l-5" style="display: inline;"
                                        data-target="#bayar" onclick="">Simpan Transaksi</button>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('post.notabebandagang') }}" class="form-horizontal"
                        role="form">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="jenis" class="form-control" required>
                                    ...
                                    <option value="Bayar sewa truk distributor Gas">Bayar sewa truk distributor Gas
                                    </option>
    ...
    <div id="edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('post.editnotabebandagang') }}" method="POST" class="form-horizontal"
